...
public class DeleteUserCredentials extends DatabaseConnection {
	...
	String deleteCarried_Over = "DELETE FROM Carried_Over";
	...
	public void initializeApplication() {
		...
		try (Connection conn = connector(); Statement stmt = conn.createStatement();) {
			stmt.executeUpdate(deleteCarried_Over);
		} catch (Exception e) {
			e.printStackTrace();
		}

		try (Connection conn = connector(); PreparedStatement pstmt = conn.prepareStatement(initializeCurrent_Status)) {
			pstmt.setLong(1, 0);
			pstmt.setLong(2, 0);
			pstmt.setLong(3, 0);
			pstmt.setLong(4, 0);
		...
		try (Connection conn = connector(); PreparedStatement pstmt = conn.prepareStatement(initializebKash_Settings)) {
			pstmt.setLong(1, 0);
		...
		try (Connection conn = connector(); PreparedStatement pstmt = conn.prepareStatement(initializeCurrent_Access)) {
		...
		try (Connection conn = connector(); PreparedStatement pstmt = conn.prepareStatement(initializeMethods_List)) {
		...
		try (Connection conn = connector(); PreparedStatement pstmt = conn.prepareStatement(initializeSource_List1)) {
		...
		try (Connection conn = connector(); PreparedStatement pstmt = conn.prepareStatement(initializeSource_List2)) {
		...
		try (Connection conn = connector(); PreparedStatement pstmt = conn.prepareStatement(initializeSector_List1)) {
		...
		try (Connection conn = connector(); PreparedStatement pstmt = conn.prepareStatement(initializeSector_List2)) {
		...
		try (Connection conn = connector(); PreparedStatement pstmt = conn.prepareStatement(initializeSector_List3)) {
		...
		try (Connection conn = connector(); PreparedStatement pstmt = conn.prepareStatement(initializeSector_List4)) {
